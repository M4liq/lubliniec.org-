 ...
 */
final class Version20190821160401 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, place_id_id INT DEFAULT NULL, author_id_id INT DEFAULT NULL, category_id_id INT DEFAULT NULL, period_id_id INT DEFAULT NULL, date DATE NOT NULL, orientation_date TINYINT(1) NOT NULL, title VARCHAR(60) DEFAULT NULL, format VARCHAR(15) DEFAULT NULL, size INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, path VARCHAR(255) NOT NULL, adding_date DATETIME DEFAULT NULL, subtitle VARCHAR(60) DEFAULT NULL, lastest_modification DATETIME DEFAULT NULL, topic VARCHAR(60) DEFAULT NULL, publicated TINYINT(1) NOT NULL, INDEX IDX_14B784189D86650F (user_id_id), INDEX IDX_14B78418D6328574 (place_id_id), INDEX IDX_14B7841869CCBE9A (author_id_id), INDEX IDX_14B784189777D11E (category_id_id), INDEX IDX_14B784184EEC1632 (period_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, place_id_id INT DEFAULT NULL, author_id_id INT NOT NULL, period_id_id INT DEFAULT NULL, date DATE NOT NULL, orientation_date TINYINT(1) DEFAULT NULL, title VARCHAR(60) NOT NULL, format VARCHAR(10) DEFAULT NULL, size INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, path VARCHAR(255) NOT NULL, adding_date DATETIME DEFAULT NULL, subtitle VARCHAR(60) DEFAULT NULL, lastest_modification DATETIME DEFAULT NULL, topic VARCHAR(255) NOT NULL, publicated TINYINT(1) DEFAULT NULL, INDEX IDX_7CC7DA2C9D86650F (user_id_id), INDEX IDX_7CC7DA2CD6328574 (place_id_id), INDEX IDX_7CC7DA2C69CCBE9A (author_id_id), INDEX IDX_7CC7DA2C4EEC1632 (period_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
