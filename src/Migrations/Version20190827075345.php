 ...
 */
final class Version20190827075345 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_section CHANGE path path VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_section CHANGE path path VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
